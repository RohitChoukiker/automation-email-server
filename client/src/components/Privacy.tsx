      ...
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-600">
            We're working hard to provide you with a comprehensive privacy policy
            that details how we collect, use, and protect your data. This page
          ...
          <div className="mt-12 rounded-3xl border border-slate-200 bg-white/90 p-8 text-left shadow-sm">
            ...
            <ul className="space-y-3 text-sm text-slate-700">
              ...
              <li className="flex items-start gap-3">
                <Shield className="mt-0.5 h-5 w-5 flex-shrink-0 text-emerald-600" />
                <span>
                  Your privacy is our top priority, and we're committed to
